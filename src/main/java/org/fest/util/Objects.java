...
public final class Objects {
  ...
  /**
   * Returns the hash code for the given object. If the object is {@code null}, this method returns zero. Otherwise calls the
   * method {@code hashCode} of the given object.
  ...
  /**
   * Casts the given object to the given type only if the object is of the given type. If the object is not of the given type,
