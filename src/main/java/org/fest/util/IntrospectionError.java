...
/**
 * Understands an error that occurred when using <a
 * href="http://java.sun.com/docs/books/tutorial/javabeans/introspection/index.html">JavaBeans Instrospection</a>.
 * 
 * @author Alex Ruiz
 */
