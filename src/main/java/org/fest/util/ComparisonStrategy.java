...
public interface ComparisonStrategy {
  ...
  /**
   * Look for given value in given {@link Iterable} according to the implemented comparison strategy, if value is found
   * it is removed from it.<br>
  ...
  /**
   * Returns true if given string contains given sequence according to the implemented comparison strategy, false
   * otherwise.
   * 
   * @param string the string to search sequence in (must not be null)
   * @param sequence the String to look for in given string
   * @return true if given string contains given sequence according to the implemented comparison strategy, false
   *         otherwise.
   */
