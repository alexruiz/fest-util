...
public class Collections_nonNullElements_List_Test {
  ...
  @Test public void should_return_null_if_given_list_is_null() {
    List<?> l = null;
    assertNull(nonNullElements(l));
  }

  @Test public void should_return_an_empty_list_if_given_list_has_only_null_elements() {
    List<String> l = new ArrayList<String>();
    l.add(null);
    assertTrue(nonNullElements(l).isEmpty());
  }

  @Test public void should_return_an_empty_list_if_given_list_is_empty() {
    List<String> l = new ArrayList<String>();
