...
public class Collections_hasOnlyNullElements_Test {
  ...
  @Test public void should_return_false_if_given_collection_is_empty() {
    assertFalse(hasOnlyNullElements(new ArrayList<String>()));
  }

  @Test public void should_return_false_if_given_collection_has_non_null_elements() {
    assertFalse(hasOnlyNullElements(list("Frodo")));
  }

  @Test(expected = NullPointerException.class) public void should_throw_NullPointerException_if_given_collection_is_null() {
