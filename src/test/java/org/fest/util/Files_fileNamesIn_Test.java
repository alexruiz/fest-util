...
public class Files_fileNamesIn_Test extends Files_TestCase {
  ...
  @Test(expected = IllegalArgumentException.class) public void should_throw_error_if_directory_does_not_exist() {
    String path = concat("root", separator, "not_existing_dir");
    Files.fileNamesIn(path, false);
  }

  @Test(expected = IllegalArgumentException.class) public void should_throw_error_if_path_does_not_belong_to_a_directory()
      throws Exception {
