...
public class Collections_nonNullElements_Collection_Test {
  ...
  @Test public void should_return_null_if_given_collection_is_null() {
    Collection<?> c = null;
    assertNull(nonNullElements(c));
  }

  @Test public void should_return_an_empty_collection_if_given_collection_has_only_null_elements() {
    Collection<String> c = new ArrayList<String>();
    c.add(null);
    assertTrue(nonNullElements(c).isEmpty());
  }

  @Test public void should_return_an_empty_collection_if_given_collection_is_empty() {
    Collection<String> c = new ArrayList<String>();
